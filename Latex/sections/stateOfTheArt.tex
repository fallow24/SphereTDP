...
LOAM~\cite{Zhang2014} is the baseline-algorthm that provides a real-time and lowdrift solution based on two parallel registration algorithms using planes and lines.
