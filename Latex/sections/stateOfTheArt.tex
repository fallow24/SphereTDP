...
Both approaches use plane-to-plane correspondences to pre-register the scans. However for pre-registration the classical point-to-point registration is also very effective. 
