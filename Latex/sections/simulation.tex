...
\begin{figure*}
	...
	\includegraphics[width=0.48\textwidth]{images/noisy_pose_and_range_top_view}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.5\textwidth]{images/sim_frame_00.png}\hfill
	\includegraphics[width=0.5\textwidth]{images/sim_frame_02.png}\\
	\includegraphics[width=0.5\textwidth]{images/sim_frame_06.png}\hfill
	\includegraphics[width=0.5\textwidth]{images/sim_frame_08.png}\\\vspace{0.5cm}
	\includegraphics[width=0.5\textwidth]{images/ProtoRoll1.png}\hfill
	\includegraphics[width=0.5\textwidth]{images/ProtoRoll2.png}
