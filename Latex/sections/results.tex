...
In particular a very large portion (95\%) have less than \SI{16.53}{\centi\meter} distances whereas in the uncorrected dataset the same portion of the points have an error of \SI{38.19}{\centi\meter} or less.
