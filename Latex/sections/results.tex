...
Figure~\ref{fig:cylon-corrected} shows the results obtained after employing the plane base registration on the dataset acquired by the floating sphere.
\begin{figure*}
	\centering
