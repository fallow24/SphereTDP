...
\begin{table}
	...
	\begin{tabular}{@{}lcccc@{}}\hline
		...
		Uncorrected & \SI{24.12}{\centi\meter} &  \SI{38.19}{\centi\meter} &  \SI{61.46}{\centi\meter} & \SI{9.97}{\centi\meter}\\
		Corrected & \SI{12.78}{\centi\meter} &  \SI{16.53}{\centi\meter} &  \SI{21.55}{\centi\meter} & \SI{6.36}{\centi\meter}\\ \hline
	\end{tabular}
