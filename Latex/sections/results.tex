...
Figure~\ref{fig:simulatedEvaluation} \todo{REDO experiments!!!} shows the different point-to-point distances. 
...
\begin{table}
	...
	\begin{tabular}{@{}lccc@{}}\hline
		...
		Corrected & \SI{12.8}{\centi\meter} &  \SI{16.6}{\centi\meter} &  \SI{21.6}{\centi\meter} \\\hline%& \SI{6.3}{\centi\meter}\\ \hline
	\end{tabular}
	\caption{Comparison of point-distances in the uncorrected and corrected simulated dataset.}
	\label{tab:percentiles}
\end{table}

The second significant peak in the right hand histogram in figure~\ref{fig:simulatedEvaluation} \todo{Explain this peak. Not sure right now.}
