...
\end{figure*}
After the registration, the walls of the environment are no longer ambiguous, since all the sub-sequent scans got matched with the initial plane representation.
