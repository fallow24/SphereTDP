...
\begin{figure}
	...
	\begin{minipage}[c]{0.45\textwidth}
		\centering
		\includegraphics[width=0.4615\textwidth, trim={20cm 0 10cm 0}, clip]{./images/cylon-exploded}\hfill
		\includegraphics[width=0.525\textwidth, trim={25cm 7.5cm 15cm 5cm}, clip]{./images/cylon-setup}\hfill
	\end{minipage}
