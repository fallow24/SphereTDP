...
\caption{(Top) Resulting 3D map using the presented algorithm for pose filtering. (Bottom) Resulting 3D map using Madgwick + double integrator for pose filtering. Both images were shot from the exact same point of view. }
\label{fig:mapping}
\end{center}
\end{figure}
...
The more detailed part of the map, as seen in the bottom left corner of the top image of Figure \ref{fig:mapping}, corresponds to the initial standstill.
...
Note that the same detailed part is also present in the bottom image.
