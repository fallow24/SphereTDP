...
The sphere from the DAEDALUS example has two completely different locomotion methods; therefore, we will not take locomotion itself into account of pose estimation. Also, the same locomotion approach leads to heavily different behavior with the same input to the controller~\cite{c2}.
...
The very impressive work in \cite{Valencia2017ASM} also uses IMUs for 6D pose estimation.
