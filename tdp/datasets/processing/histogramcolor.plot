    ...
    set grid
		...
		plot "hist.txt" using 1:2:(hsv2rgb((1-$1/100.0)*(240.0/360.0),1,1)) with boxes lc rgb variable
		...
		set lmargin 3
		set rmargin 1
		plot[0:150] "hist.txt" using 1:2:(hsv2rgb((1-$1/100.0)*(240.0/360.0),1,1)) with boxes lc rgb variable
    ...
    set view map
		...
		set bmargin 1
		set origin -0.088,0
		f(x)=(1-x/3000.0)*(240.0/360.0)
		#set cbrange [f(0):f(3000)] # [0:1]
		set cbrange [0:1] # [0:1]
		set xrange [0:3000]
		set yrange [*:*]
		set xtics 500
